...
class TFIdfPlusSGD:
    ...
    def load_models(self):
        self.tfids_vectorizer = pickle.load(open("./models/tfids_vectorizer.pickle", "rb"))
        self.sgd = pickle.load(open("./models/sgd-tfidf.pickle", "rb"))
    ...
    def predict_for_text(self, text):
        preparing_text = self.__prepare_text(text, self.tfids_vectorizer)
