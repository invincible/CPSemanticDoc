...
class LearnerBertPlusSGD:
    def __init__(self):
        self.sgd = None
        self.bert = None

    def save_models(self):
        pickle.dump(self.bert, open("./models/bert_vectorizer.pickle", "wb"))
        pickle.dump(self.sgd, open("./models/sgd-bert.pickle", "wb"))
    ...
    def learn_models(self, texts, labels):
        ...
        self.bert = TfidfVectorizer()
        x = self.__prepare_texts(texts, self.bert)
